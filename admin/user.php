...
$result = mysqli_query($mysqli, "SELECT * FROM users WHERE level='user' ORDER BY id_user DESC");
                    ...
                    <tr>
                        <?php
                            while($user_data = mysqli_fetch_array($result)) {
                                ...
                                | <a href='?page=user_hapus&id_user=$user_data[id_user]' class='btn btn-danger'>DELETE</a><center></td>";
                            }
                        ?>
                    </tr>
                </tbody>
