          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item <?php echo $page == 'admin' ? 'active' : ''; ?>">
              <a href="?page=admin" class="menu-link ">
                ...
                <div data-i18n="User interface">Admin Data</div>
              </a>
            </li>
            ...
            <li class="menu-item <?php echo $page == 'user' ? 'active' : ''; ?>">
              <a href="?page=user" class="menu-link ">
                ...
                <div data-i18n="User interface">User Data</div>
              </a>
            </li>

            <li class="menu-item <?php echo $page == 'kereta' ? 'active' : ''; ?>">
              <a href="?page=kereta" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-train"></i>
                <div data-i18n="User interface">Train Data</div>
              </a>
            </li>

            <li class="menu-item <?php echo $page == 'stasiun' ? 'active' : ''; ?>">
              <a href="?page=stasiun" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-map-pin"></i>
                <div data-i18n="User interface">Station Data</div>
              </a>
            </li>

            <li class="menu-item <?php echo $page == 'route' ? 'active' : ''; ?>">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="../assets/img/avatars/satu.png" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block"><?php echo $_SESSION['users']['nama']; ?></span>
                            <small class="text-muted"><?php echo $_SESSION['users']['username']; ?></small>
                          </div>
                        </div>
                      </a>
                    </li>
