    ...
    <div class="row">
        ...
        if ($routeResult->num_rows > 0) {
            while ($row = $routeResult->fetch_assoc()) {
                ?>
                <a href="pesanan.php?id_route=<?php echo htmlspecialchars($row['id_route']); ?>" class="train-card col-12 mb-4">
                    <div class="train-info">
                        ...
                        <div class="schedule">
                            <div class="departure">
                                <h2><?php echo htmlspecialchars($row['waktu_berangkat']); ?></h2>
                                <p>kereta tiba</p>
                            </div>
                            <div class="duration">
                            ...
                            <div class="arrival">
                                <h2><?php echo htmlspecialchars($row['waktu_tiba']); ?><span class="day-offset">+1</span></h2>
                                <p>kereta berangkat</p>
                            </div>
                        </div>
                    </div>
