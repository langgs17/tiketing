<div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h4 class="text-white fw-bold mb-4" style="letter-spacing: 3px;">Ke Mana Kamu Hari Ini?</h4>
                <h1 class="display-2 text-capitalize text-white mb-4">Enjoy Your Trip!</h1>
                <p class="text-white mb-5 fs-5">
                    Tiket Termurah dan Terpercaya Hanya Di Sneat.com
                </p>
                <ol class="breadcrumb justify-content-center mb-0">
                    <a href="?page=pesan" class="btn btn-primary rounded-pill py-2 px-4 ms-lg-4">Pesan Sekarang</a>
                </ol>    
            </div>
        </div>
        <!-- Header End -->
